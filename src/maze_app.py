...
class MazeApp:
    ...
    def __init__(self, width: int, height: int, title: str, config: Dict[str, Any]) -> None:
        ...
        # Creation of initial maze using the variables from config.txt
    ...
    def draw_maze(self, wall_color: int) -> None:
        ...
        Fills the cell completely if it's part of the '42' mask.
        """
        ...
        grid: List[List[int]] = self.generator.grid
    ...
    def handle_key(self, keycode: int, params: Any) -> int:
        ...
        if keycode in [65307, 113, 52]: # Esc, Q, 4
            ...
            # Recreate the generator with the proper config variables
